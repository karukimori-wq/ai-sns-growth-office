# AI SNS Growth Office Requirements v1.1
...
These decisions are locked for the current requirements phase.
...
Initial promoted apps may include:
...
| Stage 2: Draft Approval | Approve generated assets before scheduling | Posts, profile copy, pinned post, DM template, landing page copy |
| Stage 3: Publish/Schedule Approval | Approve final release action | Publish now, schedule, send to another app, export |
...
- Every approval request must show the proposing AI, reason, risk, expected outcome, and related client/app.
...
| --- | --- |
| Create this week's campaign route for Growth Engine | Market Research AI researches audience, SNS Strategy AI drafts route, Content AI creates posts, QC AI reviews |
...
| Content Production AI | Creates post drafts, short video scripts, carousel outlines, DM copy, and sales copy |
...
The system must diagnose why SNS activity is not leading to inquiries, bookings, or sales.
...
- Purchase or booking route
- Metrics bottleneck

### 8.3 30-Day Route Plan and Draft Set
...
| Screen | Purpose |
| --- | --- |
| CEO Dashboard | Overview of company state, approvals, tasks, and agent progress |
...
| App Marketing Workspace | Strategy and content route for each owner-built app |
| Client Workspace | Later workspace for external client support |
| Strategy Board | Route from unknown to interested to purchase |
| Content Route Calendar | 30-day plan and weekly draft set |
| Analytics Report | Funnel metrics and bottleneck diagnosis |
| Settings | Workspace, approval rules, integrations |
...
| ContentDraft | Draft content asset |
...
| SNS Planner | SNS draft creation and content planning surface |
...
1. CEO can create an instruction for marketing one owner-built app.
...
6. The system can produce a 30-day route plan.
7. The system can produce the first set of content drafts.
8. CEO approval works in three stages.
9. Publishing/scheduling remains blocked until CEO approval.
10. External Intelligence references and final decisions are recorded.

## 18. Open Questions for v1.2

These should be answered before full implementation.

1. Which owner-built app should be the first marketing target?
2. Which SNS channels are in MVP: X, Instagram, TikTok, YouTube Shorts, LINE, or another channel?
3. Does MVP need actual scheduling integration, or only a proposed schedule export?
4. Should content drafts be generated in Japanese only at first?
5. What metrics will be manually entered first: impressions, profile visits, follows, DM count, consultations, purchases, revenue?
6. Should client-facing SaaS features be completely hidden in Phase 1?
