...
- X publish job status updates now append execution history for manual required, published, and cancelled transitions.
- X publish queue cards now show manual reasons, cancel reasons, published timestamps, and publish result URLs when available.
